...
df_groups = pd.read_csv("files/component_groups.csv")
...
# Inizializza il dataframe risultati
#df_result = pd.DataFrame(index=df_temp["TempF"])


# Carica rating e variabili piping per ogni gruppo
with open("files/groupRatingInfo.json", "r") as f:
...
df_result.to_csv("files/pressures_by_temperature.csv", index=False)
