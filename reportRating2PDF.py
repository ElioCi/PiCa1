...
def UpdRepRatingPdf():
    ...
    with open('files/DatiGenerali.csv', newline='') as file_input:
    ...
    with open('files/component_groups.csv') as cmp_input:
    ...
    with open('files/pressures_by_temperature.csv') as ratingOutput:    
