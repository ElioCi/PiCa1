    ...
    if uploaded_file is not None:
        ...
        if data_ora:
            ...
            if dati_generali is not None and dati_piping is not None:
                ...
                dati_piping.to_csv("files/piping_groups.csv", index=False)
                dati_components.to_csv("files/components_groups.csv", index=False)
                dati_temperatures.to_csv("files/Temperatures.csv", index=False, sep=";")
